...
interactors_print_components_react_by_relative_url() {
        # validate inputs
        ____path="\
${XUANQI_PATH_ROOT}/entities/docs/components/react_by_relative_url/${XUANQI_LANGUAGE}.txt\
"
        if [ ! -f "$____path" ]; then
                # fallback to english
                ____path="\
${XUANQI_PATH_ROOT}/entities/docs/components/react_by_relative_url/en.txt\
"
        fi
