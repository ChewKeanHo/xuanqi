...
interactors_print_components_programmable_rendering() {
        # validate inputs
        ____path="\
${XUANQI_PATH_ROOT}/entities/docs/components/programmable_rendering/${XUANQI_LANGUAGE}.txt\
"
        if [ ! -f "$____path" ]; then
                # fallback to english
                ____path="\
${XUANQI_PATH_ROOT}/entities/docs/components/programmable_rendering/en.txt\
"
        fi
