...
#       ____url
#               - COMPULSORY
#               - the url to be redirected to using meta tag.
#       ____delay timing
#               - COMPULSORY
#               - the delay timing in round number.
#               - set to '0' for immediate redirect.
#       ____properties
#               - OPTIONAL
#               - the "key='value'" properties (e.g. id='...').
#               - "http-equiv='refresh'", "name='...'", and
#                 "content='...'" are already formulated
...
#               - error on empty/invalid '$____delay_timing'.
#               - error on invalid '$____indent_level' (e.g. not a number).
#               - error on bad execution.
views_html_head_write_redirect() {
        #____path_dest="$1"
        #____url="$2"
        #____delay_timing="$3"
        #____properties="$4"
