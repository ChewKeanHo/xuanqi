...
#       ____mime
#               - COMPULSORY
#               - the video file mime type. Recommend 'video/*' type.
#       ____description
#               - COMPULSORY
...
views_html_head_vendors_open_graph_write_thumbnail_video() {
        #____path_dest="$1"
        #____url="$2"
        #____mime="$3"
        #____description="$4"
...
$(views_html_get_indent "${7:-1}")<meta property='og:video' content='${2}' />
$(views_html_get_indent "${7:-1}")<meta property='og:video:type' content='${3}' />
$(views_html_get_indent "${7:-1}")<meta property='og:video:alt' content='${4}' />
$(views_html_get_indent "${7:-1}")<meta property='og:video:width' content='${5%"px"}' />
$(views_html_get_indent "${7:-1}")<meta property='og:video:height' content='${6%"px"}' />
"
        if [ $? -ne 0 ]; then
                return 1
        fi
