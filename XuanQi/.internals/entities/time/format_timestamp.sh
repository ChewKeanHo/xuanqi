...
# Outputs:
#       String
#               - the timestamp string in
#                 "[YEAR][MONTH][DAY][HOUR][MINUTES][SECONDS]" format.
#               - Examples
#                       - "Oct 12, 2025 14:23:20 +0000" = "20251012142320"
#                       - "Oct 12, 2025 14:23:20 +0200" = "20251012162320"
#                       - "Oct 12, 2025 14:23:20 -0200" = "20251012122320"
# Returns:
#       Return Code
#               - '0' means ok; error otherwise.
#               - error on bad execution.
entities_format_timestamp() {
        #____unix_epoch="$1"
        #____timezone="$2"
